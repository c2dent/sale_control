...
class ContractReturnEvent with _$ContractReturnEvent {
  ...
  const factory ContractReturnEvent.delete({required ContractReturn contractReturn}) = ContractReturnEventDelete;
}
...
class ContractReturnSR with _$ContractReturnSR {
  ...
  const factory ContractReturnSR.delete({required ContractReturn contractReturn}) = _ContractReturnDeleted;
}
...
class ContractReturnState with _$ContractReturnState {
  ...
  const factory ContractReturnState.data({
    ...
    required List<ContractReturn> contractReturns,
