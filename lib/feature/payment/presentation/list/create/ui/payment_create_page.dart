...
import 'package:hasap_admin/feature/payment/presentation/list/create/bloc/payment_create_bloc.dart';
...
class PaymentCreatePage extends StatelessWidget {
  ...
  void _onSingleResult(BuildContext context, PaymentCreateSR sr) {
    sr.when(
      ...
      successNotify: (text) => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(text))),
