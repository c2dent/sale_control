...
/// Это копия форка - https://github.com/marcinOz/pretty_dio_logger/tree/patch-1, которая поддерживает null safety
/// Официальный пакет не был обновлен до поддержки nullsafety
///
/// more: https://pub.dev/packages/pretty_dio_logger
      ...
      if (data != null) {
        ...
        if (data is FormData) {
          ...
          try {
            ...
            logPrint('ERROR! Not parsed to JSON:');
