...
const customcolor1 = Color(0xFF00B77D);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF00B77D),
  customcolor1: Color(0xFF006C48),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFF6EFCBB),
  onCustomcolor1Container: Color(0xFF002113),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF00B77D),
  customcolor1: Color(0xFF4DDFA1),
  onCustomcolor1: Color(0xFF003824),
  customcolor1Container: Color(0xFF005235),
  onCustomcolor1Container: Color(0xFF6EFCBB),
);
